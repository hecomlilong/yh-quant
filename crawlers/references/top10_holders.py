...
class Top10Holders(TuShareBase):
    def __init__(self):
        super(Top10Holders, self).__init__()
        """
        初始化
        """

        # 创建top10_holders数据集
        self.conn = DB_CONN['top10_holders']
    ...
    def crawl(self, ts_code, period='', ann_date='', start_date='', end_date=''):
        ...
        df = self.pro.query('top10_holders', ts_code=ts_code, period=period, ann_date=ann_date,start_date=start_date,end_date=end_date)
